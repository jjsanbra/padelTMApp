...
/**
 * REST controller for managing {@link com.padeltmapp.app.domain.Team}.
 */
@RestController
...
public class TeamResource {
     ...
     */
    @GetMapping("")
    public List<TeamDTO> getAllTeams(@RequestParam(name = "eagerload", required = false, defaultValue = "true") boolean eagerload) {
