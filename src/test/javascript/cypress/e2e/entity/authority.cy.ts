...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '262fd1cf-4baa-4861-92a8-36d047ce9897' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('990d3be4-972d-4c8e-8385-833a970395a3');
      cy.get(`[data-cy="name"]`).should('have.value', '990d3be4-972d-4c8e-8385-833a970395a3');
