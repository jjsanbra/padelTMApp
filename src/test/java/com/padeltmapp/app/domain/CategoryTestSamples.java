...
public class CategoryTestSamples {
    ...
    public static Category getCategorySample1() {
        return new Category().id(1L).categoryName("categoryName1").description("description1");
    }

    public static Category getCategorySample2() {
        return new Category().id(2L).categoryName("categoryName2").description("description2");
    }
