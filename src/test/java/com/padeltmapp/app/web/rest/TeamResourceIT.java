...
class TeamResourceIT {
    ...
    public static Team createEntity(EntityManager em) {
        Team team = new Team().teamName(DEFAULT_TEAM_NAME).logo(DEFAULT_LOGO).logoContentType(DEFAULT_LOGO_CONTENT_TYPE);
        // Add required entity
        Player player;
    ...
    public static Team createUpdatedEntity(EntityManager em) {
        Team team = new Team().teamName(UPDATED_TEAM_NAME).logo(UPDATED_LOGO).logoContentType(UPDATED_LOGO_CONTENT_TYPE);
        // Add required entity
        Player player;
        if (TestUtil.findAll(em, Player.class).isEmpty()) {
    ...
    void putExistingTeam() throws Exception {
        ...
        updatedTeam.teamName(UPDATED_TEAM_NAME).logo(UPDATED_LOGO).logoContentType(UPDATED_LOGO_CONTENT_TYPE);
    ...
    void fullUpdateTeamWithPatch() throws Exception {
        ...
        partialUpdatedTeam.teamName(UPDATED_TEAM_NAME).logo(UPDATED_LOGO).logoContentType(UPDATED_LOGO_CONTENT_TYPE);
